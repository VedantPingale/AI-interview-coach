  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center backdrop-blur-sm">
      <div className="bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-md relative border border-gray-700">
        ...
        <h2 className="text-2xl font-bold text-center mb-6 text-yellow-400">Login to Your Account</h2>
        ...
        <p className="text-center text-sm text-gray-400 mt-4">
          Don't have an account? <Link to="/register" onClick={onClose} className="text-yellow-400 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
